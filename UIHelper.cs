...
namespace CoffeeShopManagement
{
    ...
    public static class UIHelper
    {
        ...
        // Khôi phục vị trí cho form khi mở
        public static void RestoreFormPosition(Form form)
        {
            ...
            {
                form.StartPosition = FormStartPosition.CenterScreen; // Mở form ở giữa màn hình nếu không có vị trí lưu
            }
        }
    }
}
